...
Callers stay ~15 lines. All heavy lifting lives here.
...
jobs:
  release:
    uses: your-org/aichat-release-workflows/.github/workflows/release.yml@v1
    with:
...
| `tools_repo`     | string  | no       | `your-org/aichat-release-workflows` | Repo hosting these scripts.                                                       |
...
RELEASE_TAG=v1.2.4 \
RELEASE_URL=https://github.com/your-org/your-repo/releases/tag/v1.2.4 \
RELEASE_NOTES_PATH=./release-notes.md \
PRODUCT_NAME=Backend \
...
2. In a caller repo, temporarily change the `uses:` line to point at that branch:
   ```yaml
   uses: your-org/aichat-release-workflows/.github/workflows/release.yml@feat/tweak-prompt
   ```
